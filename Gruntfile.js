...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        exec: {
            ...
            androidsign: {
                command: 'rm -f cordova/project/platforms/android/build/outputs/apk/android-release-signed-aligned.apk; jarsigner -verbose -sigalg SHA1withRSA -digestalg SHA1 -keystore ../copay.keystore -signedjar cordova/project/platforms/android/build/outputs/apk/android-release-signed.apk  cordova/project/platforms/android/build/outputs/apk/android-release-unsigned.apk bitchk.com && ../android-sdk-macosx/build-tools/21.1.1/zipalign -v 4 cordova/project/platforms/android/build/outputs/apk/android-release-signed.apk cordova/project/platforms/android/build/outputs/apk/android-release-signed-aligned.apk ',
                stdin: true,
            },
            desktopsign: {
        ...
        watch: {
            ...
            wallet: {
                ...
                tasks: ['browserify:dist', 'concat:angular', 'concat:js']
            },
            gettext: {
                files: [
                    'i18n/po/*.po',
    ...
    grunt.registerTask('pack-all', ['default', 'uglify', 'exec:pack_prepare', 'exec:pack_copy', 'exec:pack_deploy']);
