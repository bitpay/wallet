...
console.log('[test.WalletFactory.js.123]'); //TODO
  ...
  it('support old index schema: #fromObj #toObj round trip', function() {
    ...
    var expected = JSON.parse(o4.replace(/cosigner/g, 'copayerIndex'));
