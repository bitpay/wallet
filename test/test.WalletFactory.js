...
describe('WalletFactory model', function() {
  ...
  describe('dont break backwards compatibility of wallets', function() {
    ...
    it.skip('should be able to import encrypted legacy wallet', function(done) {
      ...
      var wf = new WalletFactory(config, '0.0.1');
      // TODO: refactor this code from frontend to core and call a function
      // see: js/controllers/import.js:~16

      pp.getBase64Async(legacyPassword, function(passphrase) {
        var w, errMsg;
        try {
          w = wf.import(encryptedObj, passphrase);
        } catch (e) {
          errMsg = e.message;
        }
