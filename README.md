...
Please note that Copay v5.3.0 and above use CSP to restrict network access. To use a custom BWS see [CSP annoucement](https://github.com/bitpay/copay/blob/master/CSP.md). 
