(function (window, angular) {
  ...
  angular.module('app.util').provider('CUSTOMNETWORKS', function CUSTOMNETWORKSProvider () {
    ...
    this.$get = ['appConfigService', function isCUSTOMNETWORKSFactory (appConfigService) {
      this.CUSTOMNETWORKS = {          
        livenet: {
          network: 'livenet',
          name: 'livenet',
      ...
      if(!ionic.Platform.isIOS()) {
        if(appConfigService.packageName === 'bitlox' || appConfigService.packageName === 'deuscoin') {
        ...
        if(appConfigService.appName === 'BitLox' || appConfigService.packageName === 'aureus') {
