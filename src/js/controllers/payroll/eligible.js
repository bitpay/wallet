    ...
    bitpayPayrollService.checkIfEligible($scope.qualifyingData, function(err, record) {
      ...
      if (record == null) {
        ...
        return popupService.showAlert(
          ...
          gettextCatalog.getString('The email address provided ({{email}}) is not eligible for bitcoin payroll.<br/><br/>' +
            'Please contact your employer and ask them to offer bitcoin payroll through BitPay.<br/><br/>' +
