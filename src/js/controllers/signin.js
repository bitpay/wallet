...
angular.module('copayApp.controllers').controller('signinController', 
  function($rootScope, $timeout, $window, go, notification, identityService, pinService, applicationService, isMobile, isCordova, localStorageService) { 
  ...
  this.open = function(username, password) {
    $rootScope.starting = true;
    identityService.open(username, password, function(err) {
      if (err) {
