...
export class BuyGlideraPage {
  ...
  public buyConfirm(): void {
    const message = 'Buy bitcoin for ' + this.amount + ' ' + this.currency;
  ...
  public openSuccessModal(): void {
    ...
    const successComment = 'A transfer has been initiated from your bank account. Your bitcoins should arrive to your wallet in 2-4 business day';
