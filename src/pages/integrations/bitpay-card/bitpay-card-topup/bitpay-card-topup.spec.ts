...
describe('BitPayCardPurchasePage', () => {
  ...
  function testPayproTxCreationProcess(
    ...
    it('paypro test for ' + currency, async () => {
      ...
      spyOn(instance as any, 'satToFiat').and.returnValue(Promise.resolve({}));

      let initializeTopUpSpy = spyOn(
        instance as any,
        'initializeTopUp'
      ).and.callThrough();
      ...
      expect((instance as any).createdTx).toEqual(expectedCreatedTx);
    });
  }
