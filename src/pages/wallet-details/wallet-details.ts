...
export class WalletDetailsPage {
  ...
  constructor(
    ...
    const clearCache = this.navParams.data.clearCache;
  ...
  private updateTxHistory() {
    ...
    const progressFn = function(txs, newTxs) {
      if (newTxs > 5) {
        this.thistory = null;
      }
    ...
    this.walletProvider
      ...
      .then(txHistory => {
        ...
        if (hasTx) {
          this.showNoTransactionsYetMsg = false;
        } else {
          this.showNoTransactionsYetMsg = true;
        }
