...
export class PaperWalletPage {
  ...
  public ionViewWillEnter() {
    ...
    if (!this.isPkEncrypted) { this.scanFunds(); }
      ...
      const message = this.translate.instant('Private key encrypted. Enter password');
  ...
  public openSuccessModal(): void {
    const successComment = this.translate.instant("Check the transaction on your wallet details");
    const successText = this.translate.instant('Sweep Completed');
