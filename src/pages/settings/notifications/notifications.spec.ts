    ...
    describe('Methods', () => {
        describe('#openPrivacyPolicy', () => {
            it('open privacy policy with correct params', () => {
                ...
                expect(instance.externalLinkProvider.open).toHaveBeenCalledWith("https://bitpay.com/about/privacy", true, null, "View Privacy Policy", "Open", "Go Back");
            });
        });
        ...
        describe('#saveEmail', () => {
            it('should set setEmailLawCompliance with correct parameters', () => {
                ...
                instance.saveEmail();
                expect(instance.persistenceProvider.setEmailLawCompliance).toHaveBeenCalledWith('accepted');
            });
        ...
        describe('#updateConfig', () => {
            ...
            it('should update emailForm values to user email when email notifications are enabled', () => {
                ...
                spyOn(instance.emailProvider, 'getEmailIfEnabled').and.returnValue('test@satoshi.com');
            ...
            it('should update emailForm values to blank value when email notifications are disabled', () => {
                spyOn(instance.emailForm, 'setValue');
                spyOn(instance.emailProvider, 'getEmailIfEnabled').and.returnValue(null);
