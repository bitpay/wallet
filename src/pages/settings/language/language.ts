...
export class LanguagePage {
  ...
  public openExternalLink(): void {
    ...
    const message = this.translate.instant('You can make contributions by signing up on our Crowdin community translation website. We’re looking forward to hearing from you!');
