...
import { Coin, CoinsMap, CurrencyProvider } from 'src/app/providers/currency/currency';
...
export class PaperWalletPage {
  ...
  constructor(
    ...
    this.scannedKey = this.navParamsData.privateKey;
  ...
  private async openFinishModal() {
    ...
    let modal = await this.modalCtrl.create({
      ...
      componentProps: { finishText, finishComment },
      showBackdrop: true,
