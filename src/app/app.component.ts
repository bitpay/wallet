...
export class CopayApp {
  ...
  private openLockModal(): void {
    ...
    const lockMethod = config.lock.method;
  ...
  private openPINModal(action): void {
    ...
    const modal = this.modalCtrl.create(PinModalPage, { action }, { showBackdrop: false, enableBackdropDismiss: false });
    modal.present();
    modal.onDidDismiss(() => {
  ...
  private openFingerprintModal(): void {
    this.isModalOpen = true;
    const modal = this.modalCtrl.create(FingerprintModalPage, {}, { showBackdrop: false, enableBackdropDismiss: false });
    modal.present();
    modal.onDidDismiss(() => {
      this.isModalOpen = false;
    });
