...
export class GlideraProvider {
  ...
  public setCredentials() {
    ...
    const glidera = this.appProvider.servicesInfo.glidera;
  ...
  public getToken(code, cb) {
    const url = this.credentials.HOST + '/api/v1/oauth/token';
    const data = {
    ...
    this.http.post(url, data, { headers }).subscribe(
      ...
      data => {
        this.logger.error(
          'Glidera Authorization Access Token: ERROR ' + data.statusText
        );
    ...
    this.getToken(code, (err, data) => {
      ...
      this.getAccessTokenPermissions(accessToken, (err, p) => {
        ...
        this.getStatus(accessToken, (err, status) => {
          ...
          this.persistenceProvider.setGlideraToken(
            this.credentials.NETWORK,
            accessToken
          );
          this.persistenceProvider.setGlideraPermissions(
            this.credentials.NETWORK,
            p
          );
          this.persistenceProvider.setGlideraStatus(
            this.credentials.NETWORK,
            status
          );
  ...
  public getEmail(token, cb) {
    ...
    const url = this.credentials.HOST + '/api/v1/user/email';
    const headers: any = new HttpHeaders({
      'Content-Type': 'application/json',
      Accept: 'application/json',
      Authorization: 'Bearer ' + token
  ...
  public getPersonalInfo(token, cb) {
    ...
    const url = this.credentials.HOST + '/api/v1/user/personalinfo';
    const headers: any = new HttpHeaders({
      'Content-Type': 'application/json',
      Accept: 'application/json',
      Authorization: 'Bearer ' + token
    ...
    this.http.get(url, { headers }).subscribe(
      ...
      data => {
        this.logger.error(
          'Glidera Get Personal Info: ERROR ' + data.statusText
        );
        const message = data && data.message ? data.message : data.statusText;
        return cb(message);
      }
  ...
  public getStatus(token, cb) {
    ...
    const url = this.credentials.HOST + '/api/v1/user/status';
    const headers: any = new HttpHeaders({
      'Content-Type': 'application/json',
      Accept: 'application/json',
      Authorization: 'Bearer ' + token
  ...
  public getLimits(token, cb) {
    ...
    const url = this.credentials.HOST + '/api/v1/user/limits';
    const headers: any = new HttpHeaders({
      'Content-Type': 'application/json',
      Accept: 'application/json',
      Authorization: 'Bearer ' + token
    ...
    this.http.get(url, { headers }).subscribe(
      ...
      data => {
        this.logger.error(
          'Glidera Transaction Limits: ERROR ' + data.statusText
        );
        const message = data && data.message ? data.message : data.statusText;
        return cb(message);
      }
  ...
  public getTransactions(token, cb) {
    ...
    const url = this.credentials.HOST + '/api/v1/transaction';
    const headers: any = new HttpHeaders({
      'Content-Type': 'application/json',
      Accept: 'application/json',
      Authorization: 'Bearer ' + token
  ...
  public getTransaction(token, txid, cb) {
    ...
    const url = this.credentials.HOST + '/api/v1/transaction/' + txid;
    const headers: any = new HttpHeaders({
      'Content-Type': 'application/json',
      Accept: 'application/json',
      Authorization: 'Bearer ' + token
  ...
  public getSellAddress(token, cb) {
    ...
    const url = this.credentials.HOST + '/api/v1/user/create_sell_address';
    const headers: any = new HttpHeaders({
      'Content-Type': 'application/json',
      Accept: 'application/json',
      Authorization: 'Bearer ' + token
    ...
    this.http.get(url, { headers }).subscribe(
      ...
      data => {
        this.logger.error(
          'Glidera Create Sell Address: ERROR ' + data.statusText
        );
        const message = data && data.message ? data.message : data.statusText;
        return cb(message);
      }
  ...
  public get2faCode(token, cb) {
    ...
    const url = this.credentials.HOST + '/api/v1/authentication/get2faCode';
    const headers: any = new HttpHeaders({
      'Content-Type': 'application/json',
      Accept: 'application/json',
      Authorization: 'Bearer ' + token
  ...
  public sellPrice(token, price, cb) {
    ...
    const url = this.credentials.HOST + '/api/v1/prices/sell';
    const headers: any = new HttpHeaders({
      'Content-Type': 'application/json',
      Accept: 'application/json',
      Authorization: 'Bearer ' + token
  ...
  public sell(token, twoFaCode, dataSrc, cb) {
    ...
    const url = this.credentials.HOST + '/api/v1/sell';
    const headers: any = new HttpHeaders({
      'Content-Type': 'application/json',
      Accept: 'application/json',
      Authorization: 'Bearer ' + token,
  ...
  public buy(token, twoFaCode, dataSrc, cb) {
    ...
    const url = this.credentials.HOST + '/api/v1/buy';
    const headers: any = new HttpHeaders({
      'Content-Type': 'application/json',
      Accept: 'application/json',
      Authorization: 'Bearer ' + token,
          ...
          (err, permissions) => {
            ...
            if (permissions.transaction_history) {
              this.getTransactions(accessToken, (err, txs) => {
                ...
                this.persistenceProvider.setGlideraTxs(
                  this.credentials.NETWORK,
                  txs
                );
                data.txs = txs;
