  ...
  public getStatus(wallet, opts): Promise<any> {
    return new Promise((resolve, reject) => {
      ...
      const cacheBalance = (wallet, balance): void => {
        ...
        // Selected unit
        cache.unitToSatoshi = config.settings[wallet.coin].unitToSatoshi;
        ...
        cache.alternativeName = config.settings[wallet.coin].alternativeName;
        cache.alternativeIsoCode = config.settings[wallet.coin].alternativeIsoCode;
