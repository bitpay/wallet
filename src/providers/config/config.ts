...
export class ConfigProvider {
  ...
  private backwardCompatibility() {
    ...
    if (!this.configCache.wallet.settings['btc'].unitCode) {
      this.configCache.wallet.settings['btc'].unitCode = this.configDefault.wallet.settings['btc'].unitCode;
    }
    ...
    if (this.configCache.wallet.settings['btc'].unitCode == 'bit') {
      // Convert to BTC. Bits will be disabled
      this.configCache.wallet.settings['btc'].unitName = this.configDefault.wallet.settings['btc'].unitName;
      this.configCache.wallet.settings['btc'].unitToSatoshi = this.configDefault.wallet.settings['btc'].unitToSatoshi;
      this.configCache.wallet.settings['btc'].unitDecimals = this.configDefault.wallet.settings['btc'].unitDecimals;
      this.configCache.wallet.settings['btc'].unitCode = this.configDefault.wallet.settings['btc'].unitCode;
    }
  }
}
