...
describe('Provider: AmazonProvider', () => {
  ...
  describe('Function: getNetwork by default', () => {
    it("Should get livenet network by default", () => {
      ...
      expect(amazonProvider.credentials.BITPAY_API_URL).toBe('https://bitpay.com');
    });
  });
  ...
  describe('Function: setCountryParameters', () => {
    it("Should get all the data of the respective country sent", () => {
      ...
      expect(amazonProvider.getRedeemAmazonUrl()).toBe('https://www.amazon.co.jp/gc/redeem?claimCode=');
    ...
    it("Should get all the default data if a specific country was not sent", () => {
      ...
      expect(amazonProvider.getRedeemAmazonUrl()).toBe('https://www.amazon.com/gc/redeem?claimCode=');
  ...
  describe('Function: createBitPayInvoice', () => {
    ...
    it("Should do POST request to BitPay's Server to create the BitPay invoice correctly", () => {
      amazonProvider.createBitPayInvoice(newData, (err: any, dataInvoice: any) => {
        expect(err).toBe(null);
        expect(dataInvoice).toEqual({
          accessKey: "1928f88929e557",
          invoiceId: "UiaCmXc1QiwxX8edcayzzC"
        });
        expect(spyLoggerInfo).toHaveBeenCalledWith('BitPay Create Invoice: SUCCESS');
      });
    ...
    it("Should return an Error if any of data parameters are incorrect", () => {
      ...
      amazonProvider.createBitPayInvoice(newData, (errResponse: any, dataInvoice: any) => {
        expect(errResponse).toBe(data);
        expect(spyLoggerError).toHaveBeenCalledWith('BitPay Create Invoice: ERROR ' + errResponse.message);
      });
  ...
  describe('Function: getBitPayInvoice', () => {
    ...
    it("Should do GET request to BitPay's Server to get a specific BitPay invoice", () => {
      amazonProvider.getBitPayInvoice(invoiceId, (err: any, dataInvoice: any) => {
        expect(err).toBe(null);
        expect(dataInvoice).toEqual({
          data: {
            status: "new"
        ...
        expect(spyLoggerInfo).toHaveBeenCalledWith('BitPay Get Invoice: SUCCESS');
      });
    ...
    it("Should return an Error if the invoice id does not exist", () => {
      amazonProvider.getBitPayInvoice(invoiceId, (errResponse: any, dataInvoice: any) => {
        expect(errResponse).toBe(data.message);
        expect(spyLoggerError).toHaveBeenCalledWith('BitPay Get Invoice: ERROR ' + errResponse);
      });
  ...
  describe('Function: createGiftCard', () => {
    ...
    it("Should do POST request to BitPay's Server to create a Gift Card correctly", () => {
      amazonProvider.createGiftCard(newData, (err: any, data: any) => {
        ...
        expect(spyLoggerInfo).toHaveBeenCalledWith('Amazon.com Gift Card Create/Update: ' + data.status);
      });
    ...
    it("Should return an Error if any of data parameters are incorrect", () => {
      ...
      amazonProvider.createGiftCard(newData, (errResponse: any, dataInvoice: any) => {
        expect(errResponse.error).toBe(data);
        expect(spyLoggerError).toHaveBeenCalledWith('Amazon.com Gift Card Create/Update: ' + errResponse.message);
      });
  ...
  describe('Function: cancelGiftCard', () => {
    ...
    it("Should do POST request to BitPay's Server to cancel a Gift Card correctly", () => {
      amazonProvider.cancelGiftCard(newData, (err: any, data: any) => {
        ...
        expect(spyLoggerInfo).toHaveBeenCalledWith('Amazon.com Gift Card Cancel: SUCCESS');
      });
    ...
    it("Should return an Error if could not cancel the Gift Card", () => {
      amazonProvider.cancelGiftCard(newData, (errResponse: any, dataInvoice: any) => {
        expect(errResponse.error).toBe(data);
        expect(spyLoggerError).toHaveBeenCalledWith('Amazon.com Gift Card Cancel: ' + errResponse.message);
      });
